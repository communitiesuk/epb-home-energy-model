...
impl HeatStorageDryCore {
    ...
    pub(crate) fn energy_output(
        ...
        Ok((total_energy_delivered, time_used, total_energy_charged, final_soc))
    }
...
mod tests {
    ...
    fn test_demand_hot_water_with_varying_cold_temperatures(
        ...
        // Set reasonable SOC
        heat_battery.set_state_of_charge(0.8);
        ...
        assert_relative_eq!(energy, 2.0683333333333334, epsilon = 1e-7);
        ...
        assert_relative_eq!(energy_small_batches, 0.2901096300638098, epsilon = 1e-7);
        assert_relative_eq!(energy_large, 0.8779113842868205, epsilon = 1e-7);
    }

    // skipping test_demand_hot_water_zero_volume_continue as not high value and needs override of
    // single method on concrete type, which is not straightforwardly possible in Rust
}
