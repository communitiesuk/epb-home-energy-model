...
mod tests {
    ...
    #[rstest]
    #[ignore = "FHS demo files for 0.25 do not pass their published schema, so schema validation on ingestion will fail"]
    ...
    #[rstest]
    #[ignore = "FHS demo files for 0.25 do not pass their published schema"]
